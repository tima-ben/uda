 ...
 * @since 1.1.0
 */
class MyCFormatter extends CFormatter
{
    ...
    * @param string $type
    * @throws CException
    * @internal param \the $mixed value to be formatted
    * @internal param \the $string data type. This must correspond to a format method available in CFormatter.
    ...
    */
	 ...
	 */
	public function formatMoney4($value)
   {
