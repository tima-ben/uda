 ...
 */
Class MyCsvReader implements Iterator
{
   /**
    ...
    * @return self
    */
   public function __construct($source_with_names = true, $csv_str = null, $delimiter = ',', $enclosure = '"', $escape = '\\')
   {
